            ...
            <div class="row gx-0">
                <div class="col-md-6 text-center text-lg-start mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <small class="py-2"><i class="far fa-clock text-primary me-2"></i>ساعات العمل: الاثنين - الثلاثاء: 6:00 ص - 10:00 م، الأحد مغلق</small>
                    </div>
                </div>
                    ...
                    <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                        ...
                        @if (Route::has('login'))
                            <nav class="-mx-3 flex flex-1 justify-end">
                                ...
                                @else
                                    <a href="{{ route('login') }}" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">تسجيل الدخول</a>

                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">تسجيل</a>
                                    @endif
                                @endauth
                            </nav>
                        @endif
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="price.html" class="dropdown-item">خطة التسعير</a>
                            <a href="team.html" class="dropdown-item">فريقنا</a>
                            <a href="testimonial.html" class="dropdown-item">الشهادات</a>
                                <a href="appointment.html" class="dropdown-item">موعد</a>
                        </div>
                    </div>
                    <a href="" class="nav-item nav-link">تواصل</a>
