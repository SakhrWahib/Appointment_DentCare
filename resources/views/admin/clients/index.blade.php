        ...
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                <a href="{{ route('admin.clients.create') }}" class="btn btn-primary">
                    ...
                    <span class="text">{{ __('عميل جديد') }}</span>
                </a>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover datatable datatable-Client" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr data-entry-id="{{ $client->id }}">
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <form onclick="return confirm('هل أنت متأكد؟ ')" class="d-inline" action="{{ route('admin.clients.destroy', $client->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
                        ...
                        @empty
                        <tr >
                            <td colspan="7" class="text-center">{{ __('البيانات فارغة') }}</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
